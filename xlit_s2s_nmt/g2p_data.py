...
# using the g2p encoder from tensor2tensor because it's convenient, but it doesn't 
# do anything tensor2tensor specific
from xlit_t2t import g2p_encoder
...
class G2PData(problem.Text2TextProblem):
  ...
  ## these properties are just overrides to be able to use the t2t dataset/generator framework
  @property
